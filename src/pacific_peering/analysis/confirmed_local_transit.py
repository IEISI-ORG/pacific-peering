...
CONFIRMED_LOCAL_TRANSIT: tuple[ConfirmedLocalTransit, ...] = (
    ...
    ConfirmedLocalTransit(
        ...
        note=(
            ...
            "Polynesia, Cook Islands, Papua New Guinea, and Palau) for "
            "this specific direct relationship. "
            "**Eleventh independent reproduction of the downstream chain** "
            "(measurement 212143024, part of the bulk NU/FM/GU/NC clear-"
            "out, GU/AS152735 -> KI/AS132486 -- a second, genuinely "
            "different Guam network, Guam Exchange/CPDCL, not Guam "
            "Cablevision): `AS152735 -> AS7131 (PTI Pacifica) -> AS6939 "
            "-> AS14593 -> AS154100`, RIS agrees exactly (362). "
            "`has_routing_loop` False. "
            "**Eleventh independent confirmation of the direct AS154100<->"
            "AS14593 relationship** (measurement 212143026, GU/AS152735 -> "
            "KI/AS154100 directly): `AS152735 -> AS7131 -> AS6939 -> "
            "AS14593`, RIS agrees exactly (361). `has_routing_loop` False. "
            "**Twelfth and thirteenth reproductions of the downstream "
            "chain** (measurements 212143028 and 212143036, NC/AS45345 and "
            "NC/AS56089 -> KI/AS132486, part of the bulk clear-out): both "
            "`AS18200 (OPT-NC) -> AS55850 -> AS14593 -> AS154100`, RIS "
            "agrees exactly (362). `has_routing_loop` flagged `True` on "
            "both -- the already-documented Equinix Sydney fabric repeat "
            "at hop 4/5, then the known Starlink loop-adjacent addresses "
            "further in (`206.224.66.x`); not escalated. "
            "**Twelfth and thirteenth confirmations of the direct "
    ...
    ConfirmedLocalTransit(
        ...
        note=(
            ...
            "`has_routing_loop` False. "
            "**Thirteenth independent corroboration** (measurement "
            "212143023, GU/AS152735 -> NU/AS55885, a second, genuinely "
            "different Guam network, Guam Exchange/CPDCL): `AS152735 -> "
            "AS7131 (PTI Pacifica) -> AS6453 (Tata) -> AS3257 (GTT) -> "
            "AS9471 -> AS55885`, fully contiguous. Same sibling-ASN basis "
            "(`ris_agrees: false` on the strict pair). `has_routing_loop` "
            "False. "
            "**Fourteenth and fifteenth corroborations** (measurements "
            "212143027 and 212143035, NC/AS45345 and NC/AS56089, part of "
            "the bulk clear-out): both `AS18200 (OPT-NC) -> AS38195 "
            "(Superloop) -> AS3257 (GTT) -> AS9471 -> AS55885`, fully "
            "contiguous. Same sibling-ASN basis. `has_routing_loop` "
            "flagged `True` on both -- the already-documented Superloop "
            "own-network repeat at hop 4/5; not escalated."
        ),
    ),
    ConfirmedLocalTransit(
        provider_cc="FJ",
    ...
    ConfirmedLocalTransit(
        ...
        note=(
            ...
            "**Ninth independent corroboration** (measurement 212143034, "
            "NC/AS56089, part of the bulk clear-out, a second, distinct "
    ...
    ConfirmedLocalTransit(
        ...
        note=(
            ...
            "**Tenth independent corroboration** (measurement 212143025, "
            "part of the bulk NU/FM/GU/NC clear-out, GU/AS152735 -> "
            "KI/AS134783, a second, genuinely different Guam network, "
            "Guam Exchange/CPDCL): `AS152735 -> AS7131 (PTI Pacifica) -> "
            "AS6939 -> AS14593 (Starlink) -> AS154100`, RIS agrees "
            "exactly (1,392). `has_routing_loop` False. "
            "**Eleventh and twelfth corroborations** (measurements "
    ...
    ConfirmedLocalTransit(
        ...
        note=(
            ...
            "`has_routing_loop` False. "
            "**Fifth and sixth corroborations** (measurements 212143031 "
            "and 212143040, NC/AS45345 and NC/AS56089, part of the bulk "
